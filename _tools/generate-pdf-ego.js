...
(async () => {
  ...
  const filePath = path.resolve(__dirname, 'presentation-ego-glacier.html');
  ...
  await page.pdf({
    path: path.resolve(__dirname, 'Presentation-MetaAdvertising-EgoGlacier.pdf'),
    width: '1920px',
    height: '1080px',
  ...
  console.log('PDF generated: Presentation-MetaAdvertising-EgoGlacier.pdf');
  await browser.close();
})();

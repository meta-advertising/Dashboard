...
(async () => {
  ...
  const filePath = path.resolve(__dirname, 'presentation-ocargo-marseille.html');
  ...
  await page.pdf({
    path: path.resolve(__dirname, 'Presentation-Koven-Ocargo-Marseille.pdf'),
    width: '1920px',
    height: '1080px',
  ...
  console.log('PDF generated: Presentation-Koven-Ocargo-Marseille.pdf');
  await browser.close();
})();

...
(async () => {
  ...
  const filePath = path.resolve(__dirname, 'presentation-tio-bigotes.html');
  ...
  await page.pdf({
    path: path.resolve(__dirname, 'Presentation-Koven-TioBigotes.pdf'),
    width: '1920px',
    height: '1080px',
  ...
  console.log('PDF generated: Presentation-Koven-TioBigotes.pdf');
  await browser.close();
})();

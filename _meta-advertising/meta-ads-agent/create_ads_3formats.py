#!/usr/bin/env python3
"""Création des 24 pubs Biba Brunch avec 3 formats par placement.
- 1080x1080 (carré) → Fil Facebook
- 1080x1350 (portrait) → Fil Instagram
- 1080x1920 (story) → Stories FB/IG, Reels FB/IG, Profil IG

Utilise asset_feed_spec + asset_customization_rules.
instagram_actor_id est défini au niveau de l'ad set.
"""

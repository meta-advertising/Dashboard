#!/usr/bin/env python3
"""Création des 24 pubs avec format portrait uniquement pour fil Instagram."""
...
def main():
    # Supprimer le creative de test
    requests.delete(
        f"https://graph.facebook.com/v19.0/1892070448105145",
    ...
    for adset_idx, (adset_id, ad_text) in enumerate(zip(ADSET_IDS, AD_TEXTS)):
        ...
        for pair_idx, (square, portrait, theme) in enumerate(PAIRS):
            ...
            ad_data = {
                ...
                "status": "PAUSED",
                "instagram_actor_id": "17841455716206414",
            }

#!/usr/bin/env python3
"""Création des 24 publicités avec images par placement.
- 1080x1080 (carré) → Fil FB, Stories FB, Reels FB, Stories IG, Reels IG, Profil IG
- 1080x1350 (portrait) → Fil Instagram uniquement
"""
...
# Paires : (carré 1080x1080, portrait 1080x1350, thème)
PAIRS = [
...
def main():
    ...
    for adset_idx, (adset_id, ad_text) in enumerate(zip(ADSET_IDS, AD_TEXTS)):
        ...
        for pair_idx, (square, portrait, theme) in enumerate(PAIRS):
            ...
            pt_hash = IMAGE_HASHES[portrait]

            # Creative avec asset_feed_spec pour gérer les placements
            creative_spec = {

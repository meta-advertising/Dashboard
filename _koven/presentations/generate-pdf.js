...
(async () => {
  ...
  const filePath = path.resolve(__dirname, 'presentation-loveandcakes-koven.html');
  ...
  // Generate PDF
  await page.pdf({
    path: path.resolve(__dirname, 'Presentation-Koven-LoveAndCakes.pdf'),
    width: '1920px',
    height: '1080px',
  ...
  console.log('PDF generated: Presentation-Koven-LoveAndCakes.pdf');
  await browser.close();
})();
